...
# SB3 v2 renamed _flatten_obs to _stack_obs; same signature (obs_list, space).
from stable_baselines3.common.vec_env.subproc_vec_env import SubprocVecEnv, _stack_obs as _flatten_obs
